...
public class InventoryConsumerConfig {
    ...
    public Map<String, Object> consumerConfig() {
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "com.ecom.inventory_service.dtos");
        return props;
    }
    ...
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, OrderCreated>>
                    kafkaListenerContainerFactory(ConsumerFactory<String, OrderCreated> consumerFactory)
    {
