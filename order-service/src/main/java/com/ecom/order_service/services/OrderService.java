...
public interface OrderService {
    String createOrder(long userId, List<OrderItemDTORequest> orderItems) throws OrderNotFoundException;
    Order getOrder(long orderId) throws OrderNotFoundException;
    void confirmOrder(long orderId) throws OrderNotFoundException;
